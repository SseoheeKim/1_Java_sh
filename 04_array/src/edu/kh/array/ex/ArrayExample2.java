...
public class ArrayExample2 {
	...
	public void ex2(){
		...
		// char input = sc.nextChar(); The method nextChar() is undefined for the type Scanner
		// Scanner는 char자료형 입력을 지원X
		...
		boolean flag = true; 
		// true면 검색 결과 없음 / false면 검색 결과 존재
	...
	public void ex3() {
		...
		for(int row=0; row<arr.length - 1; row++) {
			for( int col=0; col<arr[row].length - 1; col++) {
				// 난수 생성 및 대입
				int ran = (int)(Math.random() * 10); // 0 ~ 9사이의 난수
				arr[row][col] = ran;
